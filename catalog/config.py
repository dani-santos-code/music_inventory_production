...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'postgresql://inventory_user:pass3421@localhost:5432/catalog')
    ACCESS_TOKEN_URI = 'https://www.googleapis.com/oauth2/v4/token'
    AUTHORIZATION_URL = 'https://accounts.google.com/o/' \
                        'oauth2/v2/auth?access_type=offline&prompt=consent'
    AUTHORIZATION_SCOPE = 'openid email profile'
    AUTH_REDIRECT_URI = 'http://www.danisantoscode.com/gCallback'
    BASE_URI = 'http://www.danisantoscode.com'
